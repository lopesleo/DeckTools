  ...
  return (
    <>
      ...
      <PanelSection title={t("helpHowToAdd")}>
        <PanelSectionRow>
          <div style={{ fontSize: "13px", color: "#dcdedf", lineHeight: "1.6", whiteSpace: "pre-line" }}>
            {t("helpHowToAddSteps")}
          </div>
        </PanelSectionRow>
      </PanelSection>
      ...
      <PanelSection title={t("helpFeatures")}>
        <PanelSectionRow>
          <div style={{ fontSize: "12px", color: "#dcdedf", lineHeight: "1.6" }}>
            {t("helpFakeAppId")}
          </div>
        </PanelSectionRow>
        <PanelSectionRow>
      ...
      <PanelSection title={t("helpTroubleshooting")}>
        <PanelSectionRow>
          <div style={{ fontSize: "12px", color: "#dcdedf", lineHeight: "1.6", whiteSpace: "pre-line" }}>
